...
DESCRIPTION_ROOT = "./data/descriptions/megadepth_processed"


class MegaDepth(BaseStereoViewDataset):
    def __init__(self, *args, split, ROOT=None, description=False, prompt_id=None, **kwargs):
        self.ROOT = DATA_ROOT
    ...
    def _get_views(self, pair_idx, resolution, rng):
        ...
        for im_id in [im1_id, im2_id]:
            ...
            try:
                ...
                if self.use_description:
                    description_path = osp.join(self.DESCRIPTION_ROOT, scene, subscene, img + '.txt')
            ...
            image, intrinsics = self._crop_resize_if_necessary(
                image, intrinsics, resolution, rng, info=(seq_path, img))
